    ...
    <div className="min-h-screen bg-black text-white flex flex-col relative overflow-hidden">
      ...
      <footer className="relative z-10 py-4 text-center">
        <p className="text-zinc-500 text-xs font-medium tracking-wide">
          powered by <a href="https://github.com/opensouls/opensouls" target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-300 transition-colors">OpenSouls</a>
        </p>
      </footer>
    </div>
  );
